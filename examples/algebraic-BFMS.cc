...
void compute()
{
	int count, width;
	cout << "\nExample:\n\talgebraic-BFMS.cc\n\n";
	cout << "Purpose:\n\tCompute values from the iterated functions "
	        "system\n\n";
	cout << "\t\tx_{i+1} = 3.75*x_i*(1-x_i)\n\n";
	cout << "\tstarting with x_0=0.5\n\n";
	cout << "\tThe computation is done with algebraic numbers based on "
	        "BFMS bounds\n\n";
	cout << "Status:\n\tUnfinished! Implementation of algebraic numbers is "
	        "only provisional!\n\n";
	cout << "Parameters:\n\tnone\n\n";
	cout << "Input:\n\t(1) Number of values to be computed, typical range: "
	        "[5..50]\n";
	cout << "\t(2) width of the output, typical range [10..100]\n\n";
	cout << "Output:\n\tValues of the iteration, together with some info "
	        "over the resulting BFMS bounds\n\n";
