...
\begin{tabular}{l|l|l|l@{\;\,\vline\,}c@{\,\vline\,}c@{\,\vline\;\,}l}
  ...
  \ttfamily tsplt &         & $(a_1..a_n)$ i64:$k$ & $(a_1..a_k)$ $(a_{k+1}..a_n)$ && & split tuple $s$ at index $k\in\{0,\ldots,n\}$ \\
  \ttfamily tconc &         & $(a_1..a_n)$ $(b_1..b_m)$ & $(a_1..a_n,b_1..b_m)$  && & concatenate $a$ and $b$ \\
  \ttfamily tlen  &         & $(a_1..a_n)$              & $(a_1..a_n)$ i64:$n$ && & extract length of $a$ \\
  \ttfamily tload &         & $(a_1..a_n)$ i64:$k$      & $(a_1..a_n)$ $a_k$ &&& load $k$-th element from $a$, $k\in\{1,\ldots,n\}$ \\
  \ttfamily tins  &         & $(a_1..a_n)$ $b$ i64:$k$  & $(a_1..a_k,b,a_{k+1}..a_n)$ &&& insert $b$ after index $k$ into $a$, $k\in\{0,\ldots,n\}$ \\
  \hline
